...
class SimpananPokok_controller extends MY_Controller
{
    ...
    {   
        ...
        if ($validation->run()) {
            $simpanan_pokok->save();
            $this->session->set_flashdata('success', 'Tambah Simpanan Sukarela Sebesar Rp. '.$simpanan_pokok->jumlah.' Berhasil Disimpan');
    ...
    public function edit($id){
        ...
        if ($validation->run()) { //lakukan validasi form
            ...
            $this->session->set_flashdata('success', 'Data Simpanan Sukarela Sebesar Rp. '.$simpanan_pokok->getById($id)->jumlah.' Berhasil Diubah');
